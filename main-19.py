...
a = generatic_Algebra(first3year, last3year, 0.8, 0.3, 1000, 1000, 1000, 10, 19, 0.2, 'group19-')
#group19-2018-09-08-01.07.49
a.load("Results/group19-2018-09-08-01.07.49", 10)
a.start()
